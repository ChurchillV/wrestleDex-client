import './App.css';
import { getAllWrestlers } from './config/api_url';
  ...
  return (
    <div className="App">
      <div className="font-bold text-3xl text-center pt-3">
        ...
        <div class="mt-8 grid sm:grid-cols-2 lg:grid-cols-3 gap-10 p-10">
          {data.map((wrestler, index) => {
            return (
              <div class="card">
                  <img src={wrestler.wrestler_img} alt="#" class="w-full h-32 sm:h-48 object-cover bg-slate-600" />
                  <div class="m-4">
                      <span class="text-bold">{wrestler.wrestler_name}</span>
