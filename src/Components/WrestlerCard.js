...
const WrestlerCard = ({wrestler, onEditButtonClick, deleteWrestler}) => {

    const handleEditClick = () => {
        onEditButtonClick(wrestler)
    }

    const deleteProfile = () => {
        deleteWrestler(wrestler.wrestler_id);
    }
        ...
        <div key={wrestler.wrestler_id} class="card">
            ...
            <div class="m-4">
                ...
                <span className="flex flex-row justify-between">
                    ...
                    <button 
                        className="bg-blue-200 text-gray-600 rounded-md px-4 py-2 hover:bg-gray-600 hover:text-blue-200 transition ease-out duration-300"
            ...
            <div className="delete-btn" onClick={deleteProfile} >
                <button className='text-xs tracking-wider cursor-pointer font-bold uppercase bg-red-600 text-gray-200 rounded-md px-4 py-2 hover:bg-red-400 hover:text-gray-300 transition ease-out duration-300'>
