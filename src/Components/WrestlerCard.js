        ...
        <div key={wrestler.wrestler_id} class="card">
            ...
            <div class="m-4">
                ...
                <div className="delete-btn">
                    <button className='text-xs tracking-wider cursor-pointer font-bold uppercase bg-red-500 text-gray-200 rounded-md px-4 py-2 hover:bg-gray-200 hover:text-red-500 transition ease-out duration-300'>
